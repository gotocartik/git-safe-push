...
const DEFAULT_PATTERNS = [
  ...
  { pattern: /\.only\b/, label: "focused test (.only)", severity: "error" },
  { pattern: /\bfit\s*\(/, label: "focused test fit()", severity: "error" },
  { pattern: /\bfdescribe\s*\(/, label: "focused test fdescribe()", severity: "error" },
